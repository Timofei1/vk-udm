...
const Hotels = ({ id, go, changeLocationVotkinsk, changeLocationIzhevsk, changeLocationSarapul, changeLocationGlazov, location }) => {
	...
	return (
		<SplitLayout modal={modalloc}>
			...
			<Panel id={id}>
				...
				<Group>
					<SimpleCell
						before={<Avatar size={72} mode="app" src='https://kmv-tur.org/sites/default/files/images/object_otdiha/2021/04/a66cb2b5e6419f72cd015d02dfad32cb.jpg' />}
					>
						Отель
					</SimpleCell>
					<SimpleCell
